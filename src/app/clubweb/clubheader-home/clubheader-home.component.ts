...
@Component({
  selector: 'app-clubheader-home',
  templateUrl: './clubheader-home.component.html',
  styleUrls: ['./clubheader-home.component.css']
})
export class ClubheaderHomeComponent implements OnInit {
